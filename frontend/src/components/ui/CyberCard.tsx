          ...
          <div id="card">
            <div className="card-content">
              ...
              <div className="subtitle">
                <span>{subtitle}</span>
                <span className="highlight">POWERED</span>
              </div>
...
const StyledWrapper = styled.div`
  ...
  .tracker:hover ~ #card .description {
    opacity: 1;
    transform: translateY(5px);
  }
  ...
  .card-badge {
    ...
    top: 15px;
    right: 15px;
    background: linear-gradient(135deg, rgba(92, 103, 255, 0.8), rgba(147, 51, 234, 0.8));
    padding: 4px 8px;
    border-radius: 4px;
    font-size: 10px;
    font-weight: bold;
  ...
  &.featured-card .container {
    box-shadow: 0 0 30px rgba(92, 103, 255, 0.3);
  }

  &.featured-card #card {
    background: linear-gradient(135deg, rgba(92, 103, 255, 0.1), rgba(147, 51, 234, 0.1));
  }

  /* Enhanced hover effects */
  &:hover .card-badge {
    background: linear-gradient(135deg, rgba(92, 103, 255, 1), rgba(147, 51, 234, 1));
